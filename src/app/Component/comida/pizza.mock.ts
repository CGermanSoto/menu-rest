export const comidaList:Comida[] = [
    {id: 1, ubicacionImagen: 'pizza.png', nombre: 'Pizza Muzzarella', ingredientes: 'Ingrediente 1, Ingrediente 2, Ingrediente 3', precio: "$1012.02"},
